...
namespace CustomPhpSettings\DI\Proxy;

use CustomPhpSettings\ProxyManager\Configuration;
use CustomPhpSettings\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use CustomPhpSettings\ProxyManager\FileLocator\FileLocator;
use CustomPhpSettings\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use CustomPhpSettings\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
 ...
 *
 * @see CustomPhpSettings\ProxyManager\Factory\LazyLoadingValueHolderFactory
 *
 * @since  5.0
