...
use CustomPhpSettings\DI\Definition\FactoryDefinition;
use CustomPhpSettings\DI\Definition\Helper\DefinitionHelper;
use CustomPhpSettings\DI\Definition\InstanceDefinition;
use CustomPhpSettings\DI\Definition\ObjectDefinition;
use CustomPhpSettings\DI\Definition\Resolver\DefinitionResolver;
use CustomPhpSettings\DI\Definition\Resolver\ResolverDispatcher;
use CustomPhpSettings\DI\Definition\Source\CachedDefinitionSource;
use CustomPhpSettings\DI\Definition\Source\DefinitionSource;
use CustomPhpSettings\DI\Definition\Source\MutableDefinitionSource;
use CustomPhpSettings\DI\Invoker\DefinitionParameterResolver;
use CustomPhpSettings\DI\Proxy\ProxyFactory;
use Exception;
use CustomPhpSettings\Interop\Container\ContainerInterface;
use InvalidArgumentException;
use CustomPhpSettings\Invoker\Invoker;
use CustomPhpSettings\Invoker\ParameterResolver\AssociativeArrayResolver;
use CustomPhpSettings\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use CustomPhpSettings\Invoker\ParameterResolver\DefaultValueResolver;
use CustomPhpSettings\Invoker\ParameterResolver\NumericArrayResolver;
use CustomPhpSettings\Invoker\ParameterResolver\ResolverChain;
 ...
 */
class Container implements ContainerInterface, FactoryInterface, \CustomPhpSettings\DI\InvokerInterface
{
    /**
